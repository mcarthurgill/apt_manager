...
class PdfsControllerTest < ActionController::TestCase
  ...
  test "should create pdf" do
    assert_difference('Pdf.count') do
      post :create, pdf: { file: @pdf.file, rental_id: @pdf.rental_id, title: @pdf.title, user_id: @pdf.user_id }
    end
  ...
  test "should update pdf" do
    put :update, id: @pdf, pdf: { file: @pdf.file, rental_id: @pdf.rental_id, title: @pdf.title, user_id: @pdf.user_id }
    assert_redirected_to pdf_path(assigns(:pdf))
  end
